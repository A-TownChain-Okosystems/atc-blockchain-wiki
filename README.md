...
> Offizielle Dokumentation für [atc-blockchain](https://github.com/A-TownChain-Okosystems/atc-blockchain) — **L3 Blockchain Core** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--blockchain-blue)](https://github.com/A-TownChain-Okosystems/atc-blockchain)
[![KAI-OS](https://img.shields.io/badge/KAI--OS-Wiki-purple)](https://github.com/A-TownChain-Okosystems/a-townchain-os-docs)
...
**→ [atc-blockchain](https://github.com/A-TownChain-Okosystems/atc-blockchain)** (`main` Branch)

---

## 📚 Dokumentation

- **[Architektur](docs/ARCHITECTURE.md)** — Systemarchitektur, Modulstruktur & Layering
- **[Konsensmechanismus](docs/CONSENSUS.md)** — PoH (Proof of History) + PoA (Proof of Authority), Chain-IDs 9000/9001
- **[Validatoren](docs/VALIDATORS.md)** — Validator Nodes, Staking, Block-Produktion & Slashing
- **[Mempool](docs/MEMPOOL.md)** — Transaktionsverwaltung, Gas Fees, Prioritisierung & Nonce-Handling
- **[Roadmap](docs/ROADMAP.md)** — Entwicklungsphasen & Meilensteine
...
- **[KAI-OS Wiki (69 Kapitel)](https://github.com/A-TownChain-Okosystems/a-townchain-os-docs)** — vollständige Software-Spezifikation
